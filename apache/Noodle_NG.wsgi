#modwsgi script for Noodle_NG

#1.Point to this script in your apache config file.
#Default location for all apps is:
#Debian:  /usr/local/turbogears/Noodle_NG

#2. Make sure apache user own the folder.
#Debian: chown -R www-data:www-data /usr/local/turbogears/Noodle_NG
...
import os, sys
sys.path.append('/usr/local/turbogears/Noodle_NG')
...
os.environ['PYTHON_EGG_CACHE'] = '/usr/local/turbogears/Noodle_NG/python-eggs'
...
#fileConfig('/usr/local/turbogears/Noodle_NG/production.ini')

#7. Load your application production.ini file.
from paste.deploy import loadapp
application = loadapp('config:/usr/local/turbogears/Noodle_NG/production.ini')


#8.[Optional] If you want to test modwsgi only, uncomment section 3 in your /usr/local/turbogears/Noodle_NG/apache/Noodle_NG
