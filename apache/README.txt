...
paster make-config Noodle_NG production.ini
...
#Edit /usr/local/turbogears/Noodle_NG/apache/Noodle_NG and make sure it has the necessary apache configurations you need. Please update any paths if youi are placing your app somewehere other then /usr/local/turbogears/Noodle_NG/

#Copy {Noodle_NG} apache config file to apache folder. Example:
cp /usr/local/turbogears/Noodle_NG/apache/Noodle_NG /etc/apache2/sites-available/Noodle_NG
...
#-rw-r--r-- 1 root root 1077 2008-11-08 12:38 Noodle_NG

#4.Enable your site.
a2ensite Noodle_NG

#5. Check if your project has proper permissions, usually apache user. (Example: www-data:www-data on Debian).
ls -l /usr/local/turbogears/Noodle_NG/apache/
#total 16
#-rw-r--r-- 1 www-data www-data 1077 2008-11-26 22:35 Noodle_NG
#-rw-r--r-- 1 www-data www-data 2319 2008-11-26 23:25 Noodle_NG.wsgi
